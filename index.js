    ...
    if(comando === "ajuda"){
      message.channel.send(":fire: Enviei minhas informaçoes em seu privado, confira! :fire: ");
       ...
       .setFooter("©GTA 5 - Todos os direitos reservados", message.author.avatarURL)
          .setDescription("\n\n:white_small_square: g!anuncio - Com este comando você pode fazer um anuncio no chat que você digitou o comando. \n\n:white_small_square:g!mute - Tira a permissão de falar da pessoa que for mutada, você deve ter o cargo **SILENCIADO** criado.\n\n :white_small_square:g!mensagem - Você manda uma mensagem para o meu criador.\n\n:white_small_square: g!perguntar - Está solitario, faça perguntas para ele o cara mais sincero.\n\n:white_small_square: g!avatar - Pegue o avatar para utiliza-lo.\n\n:white_small_square: g!serverinfo - Saiba mais desse servidor.\n\n:white_small_square: g!hospedagem - Informaçoes da máquina que me deixa ativo.\n\n:white_small_square: g!ban - Retire o jogador do seu servidor.\n\n:white_small_square: g!kick - Kick aquela pessoa chata.\n\n")
           ...
           .setFooter("©GTA 5 - Todos os direitos reservados", message.author.avatarURL)
            ...
            if(comando === "kick") {
              //adicione o nome dos cargos que vc quer que use esse comando!
                  if(!message.member.roles.some(r=>["DIRETOR","ADMINISTRADOR"].includes(r.name)) )
