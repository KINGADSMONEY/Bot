var Discord = require('discord.js')
    module.exports.run = async (bot, message, args) => {
        ...
        if(!user) return message.channel.send(message.author + "Pra quem você quer chamar a policia? Escolha!");
        ...
        let embed = new Discord.RichEmbed()
            ...
            .setColor('RANDOM')
            .setFooter(`Quem ligou ${message.author.tag}`, message.author.avatarURL)
            .setTimestamp()
